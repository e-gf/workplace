...
file_path="/chenyaofo/chenchuanshen/datasets/Youcook2/splits/test_list.txt"
output_json="/chenyaofo/chenchuanshen/workspace/generate_caption/youcook2/youcook_test_global.json"
