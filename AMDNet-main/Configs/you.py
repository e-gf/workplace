...
cfg['model_name'] = 'AMDNet'
cfg['dataset_name'] = 'Youcook2'
cfg['seed'] = 3407
cfg['data_root'] = '/chenyaofo/chenchuanshen/datasets'

cfg['visual_feature'] = 'i3d'
cfg['visual_feat_dim'] = 512
cfg['collection'] = 'Youcook2'
cfg['map_size'] = 32
cfg['event_size'] = 4


cfg['model_root'] = os.path.join('results', cfg['dataset_name'], cfg['model_name'],'all_ours_lr0.00025_lossweight_0.005')
...
# cfg['caption_rate'] = 0.0
# cfg['global_caption'] = False
cfg['caption_rate'] = 1.0
cfg['global_caption'] = True


cfg['local_hinge_weight']= 0.005
# cfg['local_hinge_weight']= 0.9
cfg['local_margin'] = 0.2
cfg['global_soft_pos_weight'] = 0.01
# cfg['global_soft_pos_weight'] = 0.9
cfg['soft_pos_margin'] = 0.1
