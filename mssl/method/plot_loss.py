...
class LossPlotter:
    ...
    def plot_losses(self):
        ...
        output_path = os.path.join(self.results_dir, 'loss_curve.png')
        plt.savefig(output_path)
        print(f'图像已保存至: {output_path}')

# ======================= demo 测试入口 =======================
if __name__ == "__main__":
    results_dir = "C:/Users/sYYmmEtry/Desktop/PRVR/test"
    loss_names = ["clip_nce_loss", "clip_trip_loss", "frame_nce_loss", "frame_trip_loss", "caption_hinge_loss", "loss_overall"]
