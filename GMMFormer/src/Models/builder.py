...
def get_models(cfg):
    model_config = EDict(
        ...
        local_hinge_weight=cfg['local_hinge_weight'],
        local_margin=cfg['local_margin'],
        global_soft_pos_weight=cfg['global_soft_pos_weight'],
        soft_pos_margin=cfg['soft_pos_margin'],
        query_or_caption=cfg['query_or_caption']
        )
