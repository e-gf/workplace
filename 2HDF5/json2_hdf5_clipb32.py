...
json_path = "/chenyaofo/chenchuanshen/workspace/generate_caption/youcook2/youcook_train_global.json"
with open(json_path, 'r', encoding='utf-8') as f:
    data = json.load(f)

# ===== 输出文件路径 =====
output_h5_path = "/chenyaofo/chenchuanshen/workspace/generate_caption/youcook2/youcook_train_global_clipb32.hdf5"
