...
class HLFormer_Net(nn.Module):
    ...
    def forward(self, batch):
        ...
        clip_scale_scores, clip_scale_scores_, frame_scale_scores, frame_scale_scores_ ,mapped_raw_clip_scale_scores\
        ...
        return [clip_scale_scores, clip_scale_scores_, label_dict, frame_scale_scores, frame_scale_scores_, 
                _curv,scale_video_query,scale_video_feat,None,video_query,mapped_raw_clip_scale_scores,global_caption_mask, local_start_end_tensor]
    ...
    def get_pred_from_raw_query(self, query_feat, query_mask, query_labels=None,
        ...
        clip_scale_scores, _= self.get_clip_scale_scores(
            video_query, video_proposal_feat)

        frame_scale_scores, _ = self.get_clip_scale_scores(
        ...
        if return_query_feats:
            ...
            return clip_scale_scores, clip_scale_scores_, frame_scale_scores, frame_scale_scores_, mapped_raw_clip_scale_scores # training
        else:
