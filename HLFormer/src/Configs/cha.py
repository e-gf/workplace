...
cfg["model_name"] = f"HLFormer"

cfg['dataset_name'] = 'charades'
cfg['seed'] = 0
cfg['root'] = '/share/home/chenyaofo/project/chenchuanshen/wfq/WorkSpace/ICCV25-HLFormer-main'
cfg['data_root'] = '/share/home/chenyaofo/project/chenchuanshen/ms-sl_gt-main/dataset'
...
cfg['num_workers'] = 2 if cfg['no_core_driver'] else cfg['num_workers']
...
cfg['global_soft_pos_weight'] = 0.005
