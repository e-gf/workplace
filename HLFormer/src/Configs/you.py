...
cfg['seed'] = 0
cfg['root'] = '/chenyaofo/chenchuanshen/workspace/HLFormer'
...
cfg['model_root'] = os.path.join(cfg['root'], 'prvr_model', cfg['dataset_name'], cfg['model_name'], 'baseline_lr0.00009_hard_negative_start_epoch100_all_ours')
